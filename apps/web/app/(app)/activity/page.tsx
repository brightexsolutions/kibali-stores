...
const ACTION_LABELS: Record<string, string> = {
  ...
  "location.deleted": "removed a shop",
  "business.deleted": "removed a business",
  "shop_login.created": "created a shop login",
  "shop_login.password_reset": "reset a shop password",
